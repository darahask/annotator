...
const ProfileRequests = (props) => {
    ...
    const handleLoadRequests = async (type) => {
        if(type === "sent") {
            ...
            if(sentRequestsList)
                ...
                handleErrorMessage("cannot load Sent Requests, Try Again");
        } else {
            ...
            if(receivedRequestsList)
                ...
                handleErrorMessage("Cannot load Received Requests, Try Again");
        }
    }
    ...
    const handleLoadUsers = async () => {
        ...
        if(allUsers)
            ...
            handleErrorMessage("Cannot load all users data, Try Again");
    }
    ...
    const handleRequestAction = async (id, action) => {
        ...
        if(status) {
            ...
            handleErrorMessage("Cannot set Request Status, Try Again");
};
    ...
    return (
            <div className="requests container p-3">
                <nav>
                    <div
                        className="nav nav-tabs row requests-navbar"
                        id="nav-tab"
                        role="tablist"
                    >
                        <button
                            ...
                            aria-selected="true"
                            onClick={() => {handleLoadRequests('sent')}} 
                        >
                        ...
                        <button
                            ...
                            aria-selected="false"
                            onClick={() => {handleLoadRequests('received')}} 
                        >
                        ...
                        <div className="row justify-content-center request-list-container">
                            <div className="col-md-8 list-container">
                                { receivedRequests.length === 0 ? ( 
                                    <div className="parent" style={{ width: "100%", height: "150px", textAlign: "center" }}>
                                        <div className="child description">
                                            You do not have any Received Requests
                                        </div>
                                    </div> ) : (
                                <div className="d-grid gap-3 list p-3">
                                    {receivedRequests.map((request) =>
